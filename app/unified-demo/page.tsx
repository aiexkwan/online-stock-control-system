    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      <Card className="border-orange-200 bg-orange-50">
        <CardHeader className="pb-3">
          ...
          <CardDescription>
            Products with stock levels below 10 units
          </CardDescription>
        </CardHeader>
        <CardContent>
        ...
        <TabsContent value="products" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Query product data using unified GraphQL API
              </CardDescription>
            </CardHeader>
                ...
                {products.map((product) => (
                  <Card key={product.id} className="hover:shadow-md transition-shadow">
                    <CardContent className="p-4">
                      <div className="font-semibold text-lg">{product.code}</div>
        ...
        <TabsContent value="pallets" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Query pallet data using unified GraphQL API
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex gap-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {pallets.map((pallet) => (
                  <Card key={pallet.id} className="hover:shadow-md transition-shadow">
                    <CardContent className="p-4">
                      <div className="font-semibold text-lg">{pallet.palletNumber}</div>
                      <div className="text-gray-600 mb-2">{pallet.productCode}</div>
                      <div className="flex justify-between items-center">
                        <Badge 
                          variant={pallet.status === 'ACTIVE' ? 'default' : 'secondary'}
                        >
                          {pallet.status}
                        </Badge>
        ...
        <TabsContent value="inventory" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Query inventory data using unified GraphQL API
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex gap-4">
        ...
        <TabsContent value="movements" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Query movement records using unified GraphQL API
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex gap-4">
