...
export function SearchHistoryDropdown({
  ...
  const [frequentSearches, setFrequentSearches] = useState<Array<{
    value: string;
    count: number;
    lastUsed: Date;
  }>>([]);
  ...
  return (
    <>
      ...
      <AnimatePresence>
        ...
        >
          <Card className="bg-slate-800/95 backdrop-blur-xl border-slate-700/50 shadow-xl">
            {/* Header */}
              ...
              {activeTab === 'recent' ? (
                ...
                <div className="p-2">
                  {frequentSearches.map((item, index) => (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div className="flex items-center justify-center w-8 h-8 rounded-full bg-orange-600/20 text-orange-400 text-xs font-medium">
                          {item.count}
                        </div>
                        <div className="font-medium text-white">
                          {item.value}
