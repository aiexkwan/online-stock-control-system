...
export function useZodForm<T extends Record<string, unknown>>({
  ...
  }, [validateForm, onSubmit, schema, values]);
...
export function useStockTransferForm(onSubmit?: (data: any) => Promise<void>) {
  return useZodForm({
...
export function useGrnForm(onSubmit?: (data: any) => Promise<void>) {
  return useZodForm({
