        ...
        <MobileCard>
          <div className={mobileConfig.spacing.stack}>
            ...
            <MobileInput
              ...
              error={idNumber.length === 4 && !isCheckingId && !isIdValid ? 'ID does not exist' : undefined}
            />
                  ...
                  return (
                    <MobileButton
                      ...
                      className={cn(
                        ...
                        isComplete && "bg-green-900/20 border-green-700/30"
                      )}
                    >
            ...
            {orderSummaries.has(selectedOrderRef) && (
              <div className="grid grid-cols-2 gap-2 p-4">
                <div className="bg-slate-700/30 rounded-lg p-3 text-center">
                  ...
                  <div className={cn(mobileConfig.fontSize.bodySmall, "text-slate-400")}>Progress</div>
                </div>
                <div className="bg-slate-700/30 rounded-lg p-3 text-center">
                  <div className={cn(mobileConfig.fontSize.h3, "font-bold text-yellow-300")}>
                    {orderSummaries.get(selectedOrderRef)!.loadedQty}
                  </div>
                  <div className={cn(mobileConfig.fontSize.bodySmall, "text-slate-400")}>Units Loaded</div>
                </div>
              </div>
            )}
          </MobileCard>
                    ...
                    >
                      ...
                      <div className="mb-3">
                        <div className="flex justify-between items-start">
                          <span className={cn(mobileConfig.fontSize.bodyLarge, "font-mono text-cyan-300")}>
                            {order.product_code}
                          </span>
                          <span className={cn(
                        ...
                        <p className={cn(mobileConfig.fontSize.body, "text-slate-300 mt-1")}>
                          {order.product_desc}
                        </p>
                      </div>
