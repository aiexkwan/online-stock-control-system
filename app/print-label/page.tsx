...
export default function PrintLabelPage() {
  ...
  return (
    <>
      ...
      <div className='fixed left-4 top-20 z-40 w-80'>
        ...
        <FloatingInstructions
          ...
          steps={[
            ...
            },
            {
              ...
              description:
                "The label will be generated and able to download. Press 'Print' button to print the label.",
            },
          ]}
        />
      </div>
          ...
          <GridWidget area='bottom-left' borderStyle='highlight'>
            <div className='h-full overflow-auto'>
              {productInfo.type === 'Slate' && (
                <h3 className='mb-4 text-lg font-semibold text-white'>Slate Product Details</h3>
              )}
        ...
        {formData.pdfProgress.total > 0 && (
          <GridWidget area='bottom-right' borderStyle='default'>
            <div className='flex h-full flex-col'>
              <h3 className='mb-4 text-lg font-semibold text-white'>Generation Progress</h3>
      ...
      {/* Bottom Info Bar */}
      <div className='fixed bottom-0 left-0 right-0 border-t border-slate-700/30 bg-slate-800/30 py-2 backdrop-blur-xl'>
