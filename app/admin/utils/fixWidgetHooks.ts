    ...
    if (file.endsWith('Widget.tsx')) {
      ...
      for (const match of matches) {
        ...
        if (functionIndex > useWidgetDataIndex && functionIndex !== -1) {
          process.env.NODE_ENV !== "production" && process.env.NODE_ENV !== "production" && console.log(`Fixing ${file}: Moving ${functionName} definition before useWidgetData`);
      ...
      process.env.NODE_ENV !== "production" && process.env.NODE_ENV !== "production" && console.log(`Processed: ${file}`);
    }
  }
}
