            ...
            {data.summary.totalAlerts > 0 && (
              <div className="text-center">
                ...
                <p className="text-xs text-gray-500">
                  {data.summary.acknowledgedCount} acknowledged, {data.summary.resolvedCount} resolved
                </p>
              </div>
            )}
          </div>
  ...
  return (
    <Card className="w-full">
      ...
      <CardContent className="space-y-6">
        {/* 告警摘要 */}
        <div>
          <h3 className="text-lg font-medium mb-3">Alert Summary</h3>
                    ...
                    <div className="flex items-center justify-between p-3 border rounded-lg">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-500">#{data.notifications.slackChannel}</p>
                        </div>
                      </div>
