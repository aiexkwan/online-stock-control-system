...
export function GlowCard({
  ...
  return (
    <motion.div
      className={cn(
        'glow-card relative overflow-visible',
        className
      )}
    ...
    >
      ...
      {!disableGlow && (
        <div
          className="glow-effect absolute inset-0 rounded-2xl pointer-events-none"
          style={{
            opacity: glowOpacity,
      ...
      {/* Main content */}
      <div className="main-content relative z-10 w-full h-full">
        {children}
      </div>
      ...
      <style jsx>{`
        ...
        .glow-effect {
          ...
          box-shadow: 
            0 0 ${THEME.glow.spread} ${theme ? THEME.colors.tabs[theme].glow : 'rgba(102,153,0,0.18)'},
            0 0 ${THEME.glow.innerSpread} ${theme ? THEME.colors.tabs[theme].glow : 'rgba(51,153,204,0.12)'},
