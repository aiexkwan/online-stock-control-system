...
export function SpotlightCard({
  ...
  return (
    <motion.div
      ref={cardRef}
      className={cn('spotlight-card-container relative group', className)}
    ...
    >
      ...
      <div 
        className="spotlight-card-content relative z-20 h-full w-full transition-all duration-300 overflow-hidden"
        style={{ borderRadius }}
      >
        {children}
      </div>
