...
export function WidgetTitle({
  ...
  return (
    <h3
      className={cn(WidgetTextStyles.title[size as string], GlowStyles[glow as string], className)}
    >
      {children}
    </h3>
  );
...
export function WidgetText({
  ...
  return (
    <p className={cn(WidgetTextStyles.body[size as string], GlowStyles[glow as string], className)}>
      {children}
    </p>
  );
}
...
export function WidgetLabel({
  ...
  return (
    <span
      className={cn(WidgetTextStyles.label[size as string], GlowStyles[glow as string], className)}
    >
      {children}
    </span>
  );
...
export function WidgetValue({
  ...
  return (
    <div
      className={cn(WidgetTextStyles.value[size as string], GlowStyles[glow as string], className)}
    >
      {children}
    </div>
  );
