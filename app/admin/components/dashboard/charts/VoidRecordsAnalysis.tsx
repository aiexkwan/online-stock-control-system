  ...
  if (error) {
    return (
      <Alert variant="destructive">
        ...
        <AlertDescription>
          Failed to load void records: {error.message}
        </AlertDescription>
      </Alert>
    );
  }
    ...
    <div className="w-full h-full flex flex-col">
      ...
      <div className="flex-1 grid grid-cols-2 gap-4">
        ...
        <div className="flex flex-col">
          <h3 className="text-sm font-medium mb-2">Void Reasons Distribution</h3>
        ...
        <div className="flex flex-col">
          <h3 className="text-sm font-medium mb-2">High Risk Products - Top 10</h3>
          <div className="flex-1">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart
                data={productData}
      ...
      {/* Summary Stats */}
      <div className="mt-4 grid grid-cols-4 gap-2 text-xs border-t pt-4">
