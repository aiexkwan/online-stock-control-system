...
// Mock the hook
jest.mock('@/app/admin/hooks/useDashboardConcurrentQuery', () => ({
...
describe('UnifiedChartWidget', () => {
  ...
  describe('Basic Functionality', () => {
    it('should render with default bar chart configuration', async () => {
      ...
      mockUseDashboardConcurrentQuery.mockReturnValue(
        mockSuccessResponse(createMockChartData()) as any
      );
  ...
  describe('Error States', () => {
    it('should handle errors with error boundary', async () => {
      const config = createChartConfig();
      mockUseDashboardConcurrentQuery.mockReturnValue(
        mockErrorResponse('Chart data fetch failed') as any
      );
  ...
  describe('Data Processing', () => {
    ...
    it('should use custom colors when provided', async () => {
      ...
      mockUseDashboardConcurrentQuery.mockReturnValue(
        mockSuccessResponse(createMockChartData({ colors: customColors })) as any
      );
  ...
  describe('Different Data Structures', () => {
    ...
    it('should handle real-time data updates', async () => {
      ...
      mockUseDashboardConcurrentQuery.mockReturnValue(
        mockSuccessResponse(initialData) as any
      );
      ...
      mockUseDashboardConcurrentQuery.mockReturnValue(
        mockSuccessResponse(updatedData) as any
      );
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle very large datasets', async () => {
      ...
      mockUseDashboardConcurrentQuery.mockReturnValue(
        mockSuccessResponse(largeData) as any
      );
