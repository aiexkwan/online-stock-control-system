  ...
  return (
    <div className="h-full w-full bg-gray-900/40 backdrop-blur-sm rounded-lg border border-gray-700/50 overflow-hidden flex flex-col">
      <div className="px-3 py-2 border-b border-gray-700/50 flex-shrink-0">
        ...
        <p className="text-xs text-gray-400 mt-0.5">{description || 'Stock Transfer Report'}</p>
      </div>
        ...
        <div className="flex items-center space-x-2 h-full">
          <div className="flex-1 relative">
            <button
              ...
              className={cn(
                "w-full flex items-center gap-2 px-3 py-2 h-9",
            ...
            >
              ...
              <span className="text-white flex-1">{getDateRangeLabel()}</span>
            </button>
              ...
              <>
                ...
                <div 
                  className={cn(
                    "fixed bg-slate-900",
                    "backdrop-blur-xl",
                    "border border-gray-600 rounded-lg shadow-2xl z-[9999]",
                    "p-3",
                    "min-w-[280px]"
                  )}
                  style={{
                ...
                >
                  ...
                  {/* Action buttons */}
                  <div className="mt-3 flex gap-2 justify-end border-t border-gray-700 pt-3">
                    <button
                      onClick={() => setIsCalendarOpen(false)}
                      className="px-3 py-1.5 text-xs bg-gray-800 hover:bg-gray-700 rounded transition-colors text-gray-300 hover:text-white"
                    >
                      Done
                    </button>
                  </div>
