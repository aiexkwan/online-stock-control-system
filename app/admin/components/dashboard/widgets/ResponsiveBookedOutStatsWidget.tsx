/**
 * Responsive Booked Out Stats Widget
...
const ResponsiveBookedOutStatsWidget = memo<WidgetComponentProps>(({ widget, isEditMode }) => {
...
ResponsiveBookedOutStatsWidget.displayName = 'ResponsiveBookedOutStatsWidget';

export default ResponsiveBookedOutStatsWidget;