...
export const UploadConfigSchema = z.object({
  ...
  allowedTypes: z.array(z.nativeEnum(SupportedFileType)).default([
...
export class FileValidator {
  static validateFile(file: File, config: z.infer<typeof UploadConfigSchema>): { valid: boolean; error?: string } {
    try {
      // 驗證文件基本信息
  ...
  static validateFileList(files: FileList, config: z.infer<typeof UploadConfigSchema>): { 
    valid: boolean; 
    validFiles: File[]; 
    errors: string[] 
  } {
