...
export async function POST(request: NextRequest) {
  try {
    process.env.NODE_ENV !== "production" && process.env.NODE_ENV !== "production" && console.log('[PDF to PNG] Starting conversion');
    ...
    try {
      ...
      process.env.NODE_ENV !== "production" && process.env.NODE_ENV !== "production" && console.log('[PDF to PNG] Using Google Docs Viewer as fallback');
      ...
      if (urlData?.publicUrl) {
        ...
        process.env.NODE_ENV !== "production" && process.env.NODE_ENV !== "production" && console.log('[PDF to PNG] Using original PDF URL for GPT-4o');
      }
