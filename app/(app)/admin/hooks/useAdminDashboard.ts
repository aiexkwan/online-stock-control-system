  ...
  useEffect(() => {
    ...
    const palletChannel = supabase
      ...
      .on(
        ...
        () => {
          isNotProduction() && console.log('Pallet data changed, refreshing stats...');
          refreshStats();
        }
      )
      .subscribe();
    ...
    const transferChannel = supabase
      ...
      .on(
        ...
        () => {
          isNotProduction() && console.log('Transfer data changed, refreshing stats...');
          refreshStats();
        }
      )
      .subscribe();
    ...
    const acoChannel = supabase
      ...
      .on(
        ...
        () => {
          isNotProduction() && console.log('ACO data changed, refreshing orders...');
          refreshOrders();
        }
      )
      .subscribe();
