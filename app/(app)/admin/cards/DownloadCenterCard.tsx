...
export const DownloadCenterCard: React.FC<DownloadCenterCardProps> = ({
        ...
        case 'aco-order':
          ...
          if (acoResult.success && acoResult.data) {
            ...
            toast({
              ...
              description:
                'error' in acoResult
                  ? extractErrorMessage(acoResult.error)
        ...
        case 'grn':
          ...
          if (grnResult.success && grnResult.data) {
            ...
            toast({
              ...
              description:
                'error' in grnResult
                  ? extractErrorMessage(grnResult.error)
                  : 'Failed to generate report',
              variant: 'destructive',
            });
          }
            ...
            toast({
              ...
              description:
                'error' in transferResult
                  ? extractErrorMessage(transferResult.error)
                  : 'Failed to generate report',
              variant: 'destructive',
            });
          }
  ...
  const [fetchAcoOrders, { data: acoOrdersData, loading: acoOrdersLoading }] = useLazyQuery(
    WAREHOUSE_ORDERS_QUERY,
    {
      variables: { input: {} },
  ...
  const [fetchGrnOptions, { data: grnOptionsData, loading: grnOptionsLoading }] = useLazyQuery(
    GRN_OPTIONS_QUERY,
    {
      variables: { limit: 500 },
      fetchPolicy: 'cache-first',
      ...
      >
        <div className='p-6'>
          ...
          <div className='w-full'>
            {/* Table header */}
            <div className='mb-4 grid grid-cols-[1fr,2fr,auto] gap-4 border-b border-slate-600/50 pb-3'>
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      {!report.available && (
                        <span
                          className={cn(cardTextStyles.labelSmall, 'mt-1 block text-amber-500')}
                        >
                          (Coming soon)
                        </span>
                      )}
      ...
      <AnimatePresence>
        {activeDropdown && (
          ...
          >
            ...
            >
              <div className='relative overflow-hidden rounded-2xl border border-zinc-800/50 bg-gradient-to-b from-zinc-900/95 to-zinc-950/95 shadow-2xl backdrop-blur-2xl'>
                ...
                <div className='p-8'>
                  <div className='mb-6 flex items-center justify-between'>
                    <div>
                      ...
                      <p className={cn(cardTextStyles.bodySmall, 'mt-1 text-zinc-400')}>
                    ...
                    <Button
                      ...
                      size='icon'
                      onClick={() => setActiveDropdown(null)}
                      className='rounded-full bg-zinc-800/50 text-zinc-400 transition-all hover:bg-zinc-700/50 hover:text-white'
                    >
                      <X className='h-4 w-4' />
                    </Button>
                  </div>
                  ...
                  {activeDropdown === 'aco-order' && (
                    <div className='space-y-4'>
                      ...
                      >
                        <SelectTrigger className='h-12 w-full border-zinc-700 bg-zinc-800/50 text-white transition-all hover:bg-zinc-800/70 focus:border-white/50 focus:bg-zinc-800/70 focus:ring-2 focus:ring-white/20'>
                          <SelectValue
                            placeholder={
                        ...
                        <SelectContent className='max-h-[300px] overflow-y-auto border-zinc-800 bg-zinc-900/95 backdrop-blur-xl'>
                          {acoOrdersLoading ? (
                            ...
                            acoOrders.map((order: WarehouseOrder) => (
                              <SelectItem
                                ...
                                className='text-zinc-300 hover:bg-zinc-800/50 hover:text-white focus:bg-zinc-800/50 focus:text-white'
                              >
                    ...
                    <div className='space-y-6'>
                      ...
                      <div className='grid grid-cols-4 gap-2'>
                        <Button
                          variant='outline'
                          size='sm'
                          className='border-zinc-700 bg-zinc-800/50 text-xs text-zinc-300 hover:bg-zinc-700/50 hover:text-white'
                          onClick={() => {
                      ...
                      <Button
                        className='h-12 w-full border-0 bg-gradient-to-r from-cyan-500 to-blue-500 text-white shadow-lg shadow-cyan-500/25 transition-all duration-200 hover:from-cyan-600 hover:to-blue-600'
      ...
      {isGenerating && (
        ...
        >
          <motion.div
            ...
            className='rounded-2xl border border-zinc-800/50 bg-zinc-900/95 p-8 shadow-2xl backdrop-blur-xl'
          >
            <div className='flex flex-col items-center'>
              <div className='relative'>
                <div className='absolute inset-0 rounded-full bg-gradient-to-r from-cyan-500/30 to-blue-500/30 blur-xl' />
              ...
              <p className={cn(cardTextStyles.bodySmall, 'mt-2 text-zinc-400')}>
