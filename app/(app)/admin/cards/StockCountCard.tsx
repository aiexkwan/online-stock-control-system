      ...
      >
        <StockCountErrorBoundary>
          ...
          <div className={cn("border-b p-4", getCardTheme('operation').border)}>
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <ClipboardDocumentListIcon className={cn("mr-2 h-5 w-5", getCardTheme('operation').icon)} />
              ...
              <div className={cn(
                ...
                <div className="flex items-start">
                  ...
                  <div className="flex-1">
                    <p className={cn(cardTextStyles.bodySmall, cardStatusColors.error.text)}>{error}</p>
                    <button
                      onClick={clearError}
                      className={cn(
          ...
          {!isCompactMode && isLoading && (
            <div className={cn(
              "border-t px-4 py-2 bg-slate-900/50",
