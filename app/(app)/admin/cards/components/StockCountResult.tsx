      ...
      <div className={`${compact ? 'space-y-3' : 'space-y-4'}`}>
        <div className='flex items-center'>
          <ClipboardDocumentCheckIcon
            className={`mr-3 ${compact ? 'h-6 w-6' : 'h-8 w-8'} text-yellow-400`}
          />
  ...
  return (
    <div className={`${compact ? 'space-y-3' : 'space-y-4'}`}>
      ...
      <div className={`${compact ? 'space-y-3' : 'space-y-4'}`}>
        ...
        <div
          className={`rounded-lg border border-green-500/30 bg-gradient-to-r from-green-600/20 to-blue-600/20 ${
            compact ? 'p-3' : 'p-6'
          }`}
        >
          <div className='text-center'>
            <label
              className={`mb-1 block ${compact ? 'text-xs' : 'text-sm'} font-medium text-green-300`}
            >
              Remaining Quantity
            </label>
            <div
              className={`bg-gradient-to-r from-green-300 to-blue-300 bg-clip-text ${
