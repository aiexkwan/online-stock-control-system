  ...
  return (
    <div className='container mx-auto space-y-8 p-6'>
      <div className='text-center'>
        <h1 className='mb-2 text-3xl font-bold text-gray-900'>ChartCard Test Page</h1>
        <p className='text-gray-600'>Testing the ChartCard component with different chart types</p>
      </div>
      ...
      {/* Test 6: Edit Mode */}
      <div className='space-y-4'>
        <h2 className='text-xl font-semibold text-gray-800'>Test 6: Edit Mode</h2>
        <div className='rounded-lg border border-gray-200 bg-white p-6 shadow-sm'>
          <ChartCard
            chartTypes={[ChartType.Line]}
            dataSources={['stock-levels']}
      ...
      <div className='space-y-4'>
        ...
        <div className='rounded-lg border border-gray-200 bg-gray-50 p-6'>
          <div className='space-y-2 text-sm'>
            ...
            <div>
              <strong>Common Data Sources:</strong> stock-levels, top-products, stock-distribution,
              inventory-cumulative, orders-trend
            </div>
            <div>
