...
export function DashboardDataProvider({
  ...
  console.log('[DEBUG as string] DashboardDataProvider initializing with:', {
    initialDateRange,
    ssrMode,
  });
  ...
  const getWidgetData = useCallback(
    <T = unknown,>(widgetId: string): T | null => {
      if (!data) return null;
  ...
  }, [startTime, endTime, ssrMode, prefetchedData, queryData, refetch]);
