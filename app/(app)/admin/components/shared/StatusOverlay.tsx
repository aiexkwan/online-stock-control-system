        ...
        >
          <motion.div
            ...
            className={cn(
              'relative',
              mode === 'modal' &&
                'w-96 rounded-xl border border-gray-700 bg-gray-900 p-8 shadow-2xl'
            )}
          ...
          >
            ...
            <div className={cn('text-center', mode === 'modal' && 'space-y-6')}>
              {/* Icon */}
              ...
              <div className='mb-8'>
                ...
                {message && (
                  <p
                    className={cn('text-lg', mode === 'modal' ? 'text-gray-300' : 'text-white/80')}
                  >
                    {message}
                  </p>
                )}
                {details && <div className='mt-4 text-sm text-gray-400'>{details}</div>}
              </div>
