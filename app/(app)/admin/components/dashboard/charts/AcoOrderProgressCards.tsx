          ...
          >
            <div className='mb-3 flex items-center justify-between'>
              ...
              <div className='flex items-center gap-3'>
                {card.description && (
                  <span className='text-sm text-slate-400'>{card.description}</span>
                )}
            ...
            <div className='grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-3'>
              <div className='rounded-lg border border-slate-600/20 bg-slate-800/50 p-3'>
                ...
                {card.previousValue && (
                  <div className='mb-2 text-sm text-slate-400'>Previous: {card.previousValue}</div>
                )}
              ...
              {card.category && (
                <div className='rounded-lg border border-slate-600/20 bg-slate-800/50 p-3'>
                  ...
                  <div className='text-sm text-slate-400'>{card.category}</div>
                </div>
              )}
            </div>
          </motion.div>
