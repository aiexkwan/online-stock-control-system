          ...
          <div className='relative'>
            ...
            >
              <div className='flex items-center gap-3'>
                <div className={cn('h-3 w-3 rounded-full', selectedDept?.color)} />
            ...
            {isOpen && (
              <motion.div
                ...
                exit={{ opacity: 0, y: -10 }}
                className='absolute left-0 right-0 top-full z-50 mt-2 rounded-lg border bg-background shadow-lg'
              >
