...
} from '@/app/(app)/admin/components/ui/admin-dialog';
import {
  Select,
  SelectContent,
  SelectItem,
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className='sm:max-w-[425px]'>
          ...
          <div className='grid gap-4 py-4'>
            {error && (
              <div
                className={cn('rounded-md border p-3', 'border-destructive/20 bg-destructive/10')}
              >
                <p
                  className={cn(textClasses['body-small'])}
            ...
            <div className='grid gap-2'>
              <label
                htmlFor='reference'
                className={cn(textClasses['body-small'], 'font-medium text-foreground')}
              >
                {selectLabel}
              </label>
            ...
            >
              ...
              {downloadStatus === 'downloading' && (
                <div className='z-[5] flex items-center justify-center'>
                  <div className='mr-2 h-1 w-6 rounded-full bg-slate-400' />
                  {Math.round(progress)}%
                </div>
              )}
