...
import { useWidgetToast, WidgetToastPresets } from '@/app/(app)/admin/hooks/useWidgetToast';
                  ...
                  >
                    <Calendar
                      ...
                      classNames={{
                        ...
                        head_row: 'flex',
                        head_cell: cn(
                          'text-muted-foreground rounded-md w-7 font-normal',
