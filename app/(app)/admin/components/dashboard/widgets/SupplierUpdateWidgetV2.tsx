...
export const SupplierUpdateWidgetV2 = React.memo(function SupplierUpdateWidgetV2({
  ...
  const { handleSuccess, handleError, handleWarning, handleSubmitError } = useWidgetErrorHandler(
    widget && 'title' in widget && typeof widget.title === 'string'
      ? widget.title
      : widget?.config?.title && typeof widget.config.title === 'string'
        ? widget.config.title
        : 'Supplier Update'
  );
  // State management
  ...
  const handleSearch = useCallback(
    async (code: string) => {
      ...
      try {
        ...
        console.log(
          `[SupplierUpdateWidgetV2] Server Action search: ${Math.round(endTime - startTime)}ms`
        );
        ...
        <CardContent className='max-h-[calc(100%-60px)] space-y-4 overflow-y-auto'>
          ...
          {!showForm && !showCreateDialog && (
            <div className='space-y-3'>
              <Label
                htmlFor='search'
                className={cn(textClasses['body-small'], 'text-muted-foreground')}
              >
                Supplier Code
              </Label>
              <div className='flex gap-2'>
                <Input
                  ...
                  className={cn('h-9 flex-1 border-input bg-background', textClasses['body-small'])}
          ...
          {/* Create Confirmation */}
          {showCreateDialog && (
            <div className={cn('border-warning/30 rounded-lg border bg-card/50 p-4')}>
                ...
                <div className='flex-1'>
                  ...
                  <div className='mt-3 flex gap-2'>
                    <Button
                      ...
                      size='sm'
                      className={cn(
                        'bg-success hover:bg-success/90 text-success-foreground h-8',
                        textClasses['body-small']
                      )}
                      disabled={isEditMode}
                    >
                    ...
                    <Button
                      ...
                      size='sm'
                      variant='outline'
                      className={cn('h-8 border-border', textClasses['body-small'])}
                      disabled={isEditMode}
                    >
                      Cancel
                    </Button>
          ...
          {supplierData && !showForm && (
            <div className={cn('rounded-lg border border-border bg-card/50 p-4')}>
              <div className='mb-3 flex items-center justify-between'>
                ...
                <Button
                  ...
                  size='sm'
                  className={cn(
                    'h-7 bg-primary px-3 text-primary-foreground hover:bg-primary/90',
            ...
            <form onSubmit={handleSubmit} className='space-y-4'>
              ...
              <div className='space-y-3'>
                <div>
                  ...
                  <Input
                    ...
                    className={cn('mt-1 h-9 border-input bg-background', textClasses['body-small'])}
                    required
                  />
                </div>
              ...
              <div className='flex gap-2 pt-2'>
                <Button
                  ...
                  size='sm'
                  variant='outline'
                  className={cn('h-8 flex-1 border-border', textClasses['body-small'])}
                  disabled={searchLoading || isEditMode}
                >
                  Cancel
                </Button>
                <Button
                  ...
                  disabled={searchLoading || isEditMode}
                  className={cn(
                    'h-8 flex-1 bg-primary text-primary-foreground hover:bg-primary/90',
                    textClasses['body-small']
                  )}
                >
                  {isLoading ? (
          ...
          {performanceMetrics.optimized && (
            <div className={cn('text-success mt-2 text-center', textClasses['label-small'])}>
