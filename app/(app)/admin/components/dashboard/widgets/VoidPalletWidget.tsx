...
import { useBatchVoid } from '@/app/(app)/void-pallet/hooks/useBatchVoid';
import { VOID_REASONS } from '@/app/(app)/void-pallet/types';
import { BatchPalletItem } from '@/app/(app)/void-pallet/types/batch';
import {
  VoidReasonDefinition,
  VoidBatchItem,
  VoidDataMapper,
  isValidVoidReason,
} from '@/app/(app)/void-pallet/types/SupabaseVoidTypes';
import { BatchVoidPanel } from '@/app/(app)/void-pallet/components/BatchVoidPanel';
    ...
    <div className='space-y-4'>
      ...
      {batchState.mode === 'single' && state.foundPallet && (
        <div className='rounded-lg border border-border bg-card p-4'>
          <h4 className={cn('mb-3', textClasses['label-large'], 'text-muted-foreground')}>
            Pallet Information
          </h4>
          <div className='grid grid-cols-2 gap-4'>
            {/* Row 1 */}
            <div>
              <p className={cn(textClasses['body-base'], 'font-medium')}>
                {state.foundPallet.plt_num}
              </p>
