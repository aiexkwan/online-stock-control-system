...
const ChartErrorFallback = ({ chartName }: { chartName: string }) => (
  <div className={cn('flex h-48 flex-col items-center justify-center', 'text-muted-foreground')}>
            ...
            >
              ...
              >
                ...
                <div className='flex items-center gap-3 p-4'>
                  ...
                  >
                    <h3
                      className={cn(textClasses['body-base'], 'font-bold text-primary-foreground')}
                    >
                      {option.title}
                    </h3>
                    <p className={cn(textClasses['body-small'], 'text-primary-foreground/70')}>
                      {option.subtitle}
                    </p>
                  </div>
                </div>
