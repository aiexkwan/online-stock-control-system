  ...
  ({
    ...
    return (
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        {errors.productCode && (
          <p className="text-sm text-red-400">{errors.productCode}</p>
        )}
        ...
        <div className="space-y-1">
          ...
          />
          {errors.count && (
            <p className="text-sm text-red-400">{errors.count}</p>
          )}
        ...
        <div className="space-y-1">
          ...
          />
          {errors.operator && (
            <p className="text-sm text-red-400">{errors.operator}</p>
          )}
        </div>
        ...
        <button
          ...
          className={`w-full flex items-center justify-center gap-2 rounded-md px-4 py-3 text-sm font-medium transition-colors ${
