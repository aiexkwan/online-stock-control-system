  ...
  <AdminDialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'border border-slate-700/50 bg-slate-800/95 text-white backdrop-blur-xl',
    ...
    >
      {children}
      <DialogPrimitive.Close className='absolute right-4 top-4 rounded-sm opacity-70 ring-offset-slate-800 transition-all hover:rotate-90 hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:pointer-events-none'>
