                ...
                <div className="space-y-6">
                  ...
                  {productInfo && (
                    <div className="p-4 bg-gray-750 rounded-lg border border-gray-600">
                      <h4 className="text-sm font-medium text-white mb-2">Product Information</h4>
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                        <div>
                          <span className="text-gray-400">Description:</span>
                          <span className="text-white ml-2">{productInfo.description}</span>
                        </div>
                        <div>
                          <span className="text-gray-400">Standard Qty:</span>
                          <span className="text-white ml-2">{productInfo.standard_qty}</span>
                        </div>
                        <div>
                          <span className="text-gray-400">Type:</span>
                          <span className={`ml-2 px-2 py-1 rounded text-xs font-medium ${
                            productInfo.type === 'ACO' ? 'bg-blue-100 text-blue-800' :
                            productInfo.type === 'Slate' ? 'bg-purple-100 text-purple-800' :
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <EnhancedFormField
                      ...
                      required
                      error={errors.count}
                      hint={productInfo?.type === 'Slate' ? 'Fixed to 1 for Slate products' : undefined}
                    >
                      <EnhancedInput
                        type="number"
                    ...
                    >
                      <div className="space-y-4">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          ...
                          >
                            <EnhancedInput
                              ...
                              onChange={(e) => handleSlateDetailChange('firstOffDate', e.target.value)}
                              error={errors.firstOffDate}
                            />
                          </EnhancedFormField>
                          ...
                          >
                            <EnhancedInput
                              ...
                              onChange={(e) => handleSlateDetailChange('batchNumber', e.target.value)}
                        ...
                        >
                            ...
                            {[
                              ...
                              >
                                <EnhancedInput
                                  ...
                                  onChange={(e) => handleSlateDetailChange(field.key as keyof SlateDetail, e.target.value)}
                          ...
                          >
                            <textarea
                              className="w-full rounded-lg border border-gray-700 bg-gray-900 text-white px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none"
                              rows={3}
