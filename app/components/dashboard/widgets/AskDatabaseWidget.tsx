...
export function AskDatabaseWidget({ widget, isEditMode }: WidgetComponentProps) {
  ...
  return (
    <div className="relative group h-full">
      ...
      <div className={`relative bg-slate-800/40 backdrop-blur-xl border border-purple-500/30 rounded-2xl p-6 shadow-2xl shadow-purple-900/20 hover:border-purple-400/50 transition-all duration-300 h-full ${isEditMode ? 'border-dashed border-2 border-purple-500/50' : ''}`}>
        {/* 卡片內部光效 */}
        ...
        <div className="relative z-10 h-full flex flex-col">
          ...
          <div className="flex-1">
            {isEditMode ? (
              <div className="h-full flex items-center justify-center bg-slate-800/50 rounded-xl border border-purple-500/20">
