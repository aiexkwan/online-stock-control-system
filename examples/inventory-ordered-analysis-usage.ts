    ...
    <div>
      ...
      <div className="summary-stats">
        ...
        <div className="status-breakdown">
          ...
          <div className="insufficient">Insufficient Stock: {analysis.summary.products_insufficient}</div>
      ...
      <table className="analysis-table">
        ...
        <tbody>
          {analysis.data.map((product) => (
            <tr key={product.product_code} className={`status-${product.analysis.status.toLowerCase().replace(' ', '-')}`}>
              ...
              <td>
                <span className={`status-badge ${product.analysis.status.toLowerCase().replace(' ', '-')}`}>
