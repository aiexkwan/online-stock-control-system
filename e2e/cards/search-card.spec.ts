  ...
  test.describe('Different Search Configurations', () => {
    test('should handle product-only search', async ({ page }) => {
      ...
      const productSearch = page
        .locator('h2:has-text("Product-only Search")')
        .locator('..')
        .locator('input');
    ...
    test('should handle multi-entity search', async ({ page }) => {
      ...
      const multiEntitySearch = page
        .locator('h2:has-text("Multi-entity Search")')
        .locator('..')
        .locator('input');
    ...
    test('should handle advanced search', async ({ page }) => {
      ...
      const advancedSearch = page
        .locator('h2:has-text("Advanced Search")')
        .locator('..')
        .locator('input');
      ...
      await expect(advancedSearch).toHaveAttribute(
        'placeholder',
    ...
    test('should handle compact search', async ({ page }) => {
      ...
      const compactSearch = page
        .locator('h2:has-text("Compact Search")')
        .locator('..')
        .locator('input');
  ...
  test.describe('Console Error Monitoring', () => {
    test('should not generate console errors during normal operation', async ({ page }) => {
      ...
      const relevantErrors = consoleErrors.filter(
        error =>
          !error.includes('fetch') && !error.includes('NetworkError') && !error.includes('GraphQL')
      );
