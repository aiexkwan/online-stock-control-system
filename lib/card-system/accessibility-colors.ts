...
export const colorBlindFriendlyChartColors = {
  ...
  diverging: {
    ...
    greenPurple: ['#40004b', '#762a83', '#9970ab', '#c2a5cf', '#e7d4e8', '#d9f0d3', '#a6dba0', '#5aae61', '#1b7837', '#00441b'],
  },
} as const;
 ...
 * 基於基礎顏色生成完整的無障礙主題
 */
export function generateAccessibleTheme(baseColor: string, cardType: keyof typeof accessibleCardColors) {
