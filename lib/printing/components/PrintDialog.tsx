      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 py-4">
          ...
          <div className="space-y-4">
            <h3 className="font-semibold text-sm">Print Options</h3>
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) => setOptions(prev => ({ ...prev, paperSize: value as PaperSize }))}
              >
            ...
            <div className="space-y-2">
              ...
              <RadioGroup
                ...
                onValueChange={(value) => setOptions(prev => ({ ...prev, priority: value as PrintPriority }))}
              >
                <div className="flex items-center space-x-2">
