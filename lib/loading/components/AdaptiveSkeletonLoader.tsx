...
export function AdaptiveSkeletonLoader({
    ...
    if (!animationConfig.useMotion) {
      return (
        <div
          ...
          className={cn(
            itemClass,
            animationConfig.animation === 'pulse' && 'animate-pulse'
          )}
        />
      );
    }
          ...
          <div className={sizeConfig.spacing}>
            {Array.from({ length: adjustedRows }, (_, i) => (
              <div key={i} className="flex items-center space-x-3">
                <div className="h-2 w-2 bg-slate-700/40 rounded-full" />
      ...
      case 'chart':
        return (
          <div className="space-y-4">
            ...
            <div className="h-48 bg-slate-700/20 rounded-lg flex items-end justify-between p-4">
  ...
  return (
    <div 
      className={cn(
        'animate-pulse',
        type === 'card' && 'bg-slate-800/30 rounded-lg border border-slate-700/20',
        className
      )}
