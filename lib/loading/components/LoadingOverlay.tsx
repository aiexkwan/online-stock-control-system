...
export function LoadingOverlay({
  ...
  const renderError = () => {
    ...
    return (
      <div className="flex items-center gap-3 mt-4 p-4 bg-red-500/10 border border-red-500/20 rounded-lg">
  ...
  const contentContainer = (
    <div
      className="flex flex-col items-center justify-center max-w-md mx-auto p-6"
    ...
    >
      ...
      {cancellable && !showCloseButton && (
        <p className={cn('text-xs mt-4 opacity-70', themeConfig.text)}>
          Press ESC to cancel
        </p>
      )}
    </div>
...
export const ModalLoadingOverlay = (props: Omit<LoadingOverlayExtendedProps, 'fullscreen' | 'theme'>) => (
