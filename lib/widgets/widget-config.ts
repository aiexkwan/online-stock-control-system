...
export const UNIFIED_WIDGET_CONFIG: Record<string, UnifiedWidgetConfig> = {
  ...
  OrdersListWidgetV2: {
    ...
    name: 'Orders List V2',
    category: 'lists',
    description: 'Display orders with GraphQL optimization using UniversalListWidget',
    lazyLoad: true,
    preloadPriority: 8,
    metadata: {
  ...
  OtherFilesListWidgetV2: {
    ...
    category: 'lists',
    description: 'Display other files with GraphQL optimization using UniversalListWidget',
    lazyLoad: true,
    preloadPriority: 6,
    metadata: {
      // UniversalListWidget 配置
  ...
  OrderStateListWidgetV2: {
    ...
    category: 'lists',
    description: 'Display order states with GraphQL optimization using UniversalListWidget',
    lazyLoad: true,
    preloadPriority: 7,
    metadata: {
      // UniversalListWidget 配置
