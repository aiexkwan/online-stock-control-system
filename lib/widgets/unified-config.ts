...
export const widgetConfig: WidgetConfigMap = {
  ...
  StockDistributionChartV2: {
    ...
    loader: () => import('@/app/(app)/admin/components/dashboard/widgets/StockDistributionChartV2'),
    dataSource: 'batch',
    priority: 'high',
    refreshInterval: 300000,
    metadata: {
  ...
  OrdersListV2: {
    ...
    loader: () => import('@/app/(app)/admin/components/dashboard/widgets/OrdersListWidgetV2'),
    dataSource: 'batch',
    priority: 'normal',
  },
  ...
  OtherFilesListV2: {
    ...
    loader: () => import('@/app/(app)/admin/components/dashboard/widgets/OtherFilesListWidgetV2'),
    dataSource: 'batch',
    priority: 'normal',
  },
  ...
  OrderStateListV2: {
    ...
    loader: () => import('@/app/(app)/admin/components/dashboard/widgets/OrderStateListWidgetV2'),
    dataSource: 'batch',
    priority: 'normal',
  },
  ...
  ProductUpdateV2: {
    ...
    loader: () => import('@/app/(app)/admin/components/dashboard/widgets/ProductUpdateWidgetV2'),
    dataSource: 'server-action',
    priority: 'normal',
  },
  ...
  SupplierUpdateV2: {
    ...
    loader: () => import('@/app/(app)/admin/components/dashboard/widgets/SupplierUpdateWidgetV2'),
    dataSource: 'server-action',
    priority: 'normal',
  },
  ...
  UploadOrdersV2: {
    ...
    loader: () => import('@/app/(app)/admin/components/dashboard/widgets/UploadOrdersWidgetV2'),
    dataSource: 'server-action',
    priority: 'normal',
  },
  ...
  GrnReportV2: {
    ...
    loader: () => import('@/app/(app)/admin/components/dashboard/widgets/GrnReportWidgetV2'),
    dataSource: 'mixed',
    priority: 'normal',
  },
  ...
  AcoOrderReportV2: {
    ...
    loader: () => import('@/app/(app)/admin/components/dashboard/widgets/AcoOrderReportWidgetV2'),
    dataSource: 'batch',
    priority: 'normal',
  },
  ...
  AnalysisPagedV2: {
    ...
    loader: () => import('@/app/(app)/admin/components/dashboard/widgets/AnalysisPagedWidgetV2'),
    dataSource: 'batch',
    priority: 'normal',
  },
