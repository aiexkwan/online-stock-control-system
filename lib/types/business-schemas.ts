...
export class BusinessSchemaValidator {
  static validateVoidRecord(data: unknown): VoidRecord {
    try {
      ...
      throw new Error(`Invalid void record: ${error instanceof Error ? error.message : 'Unknown error'}`);
    }
  }
  ...
  static validateReportVoidRecord(data: unknown): ReportVoidRecord {
    try {
      ...
      throw new Error(`Invalid report void record: ${error instanceof Error ? error.message : 'Unknown error'}`);
    }
  }
  ...
  static validateInventoryTransaction(data: unknown): InventoryTransaction {
    try {
      ...
      throw new Error(`Invalid inventory transaction: ${error instanceof Error ? error.message : 'Unknown error'}`);
    }
  }
  ...
  static validateBatchProcessingResult(data: unknown): BatchProcessingResult {
    try {
      ...
      throw new Error(`Invalid batch processing result: ${error instanceof Error ? error.message : 'Unknown error'}`);
    }
  }

  static safeParseVoidRecord(data: unknown): { success: true; data: VoidRecord } | { success: false; error: string } {
    try {
