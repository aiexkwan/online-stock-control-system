/**
 * Optimized GraphQL Client Configuration for Supabase
 * 解決開發環境閃爍問題
 */
...
/**
 * Optimized GraphQL client for Supabase with caching
 */
...
/**
 * Optimized React Hook for GraphQL queries
 * 解決 React Strict Mode 同開發環境嘅重複請求問題
 */
