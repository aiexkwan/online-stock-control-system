 ...
 * 獲取組件間距
 */
export function getComponentSpacing(type: keyof typeof componentSpacing, size: string): string {
  return (componentSpacing[type] as Record<string, string>)?.[size] || spacing[4];
}
