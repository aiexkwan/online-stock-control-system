...
export const dialogButtonStyles = {
  primary: {
    notification: "bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-500 hover:to-cyan-500",
    error: "bg-gradient-to-r from-red-600 to-rose-600 hover:from-red-500 hover:to-rose-500",
    warning: "bg-gradient-to-r from-yellow-600 to-amber-600 hover:from-yellow-500 hover:to-amber-500",
    form: "bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-500 hover:to-cyan-500",
    report: "bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500",
    information: "bg-gradient-to-r from-cyan-600 to-teal-600 hover:from-cyan-500 hover:to-teal-500"
  },
  secondary: "bg-slate-700/50 hover:bg-slate-600/50 border border-slate-600/50 hover:border-slate-500/70"
} as const;

export type DialogVariants = VariantProps<typeof dialogVariants>;
export type DialogType = keyof typeof dialogIconColors;