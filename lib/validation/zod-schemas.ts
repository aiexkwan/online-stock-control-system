...
// 驗證函數
export function validateApiRequest(data: unknown): { success: boolean; data?: ApiRequest; error?: string } {
...
export function validateDatabaseRecord(data: unknown): { success: boolean; data?: DatabaseRecord; error?: string } {
...
export function validateQueryParams(data: unknown): { success: boolean; data?: QueryParams; error?: string } {
