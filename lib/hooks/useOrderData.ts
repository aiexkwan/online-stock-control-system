...
export function useOrderData(config: OrderDataConfig = {}): UseOrderDataReturn {
  ...
  } = useQuery<WarehouseOrdersData, WarehouseOrdersVariables>(WAREHOUSE_ORDERS_QUERY, {
  ...
  ] = useLazyQuery<WarehouseOrderData, WarehouseOrderVariables>(WAREHOUSE_ORDER_QUERY, {
    ...cacheConfig,
    onError: error =>
      handleError(error, {
        component: 'useOrderData',
  ...
  ] = useLazyQuery<AcoOrderReportData, AcoOrderReportVariables>(ACO_ORDER_REPORT_QUERY, {
    ...cacheConfig,
    onError: error =>
      handleError(error, {
        component: 'useOrderData',
  ...
  >(UPDATE_WAREHOUSE_ORDER_STATUS, {
    ...
    optimisticResponse: config.optimisticUpdates
      ? variables => ({
  ...
  const fetchWarehouseOrderCallback = useCallback(
    async (variables: WarehouseOrderVariables) => {
      try {
  ...
  const fetchAcoOrderReportCallback = useCallback(
    async (variables: AcoOrderReportVariables) => {
      try {
  ...
  const fetchOrderLoadingRecordsCallback = useCallback(
    async (variables: OrderLoadingRecordsVariables) => {
      try {
  ...
  const actions: OrderDataActions = useMemo(
    () => ({
      ...
      updateOrderStatus: async (
        variables: UpdateWarehouseOrderStatusVariables
      ): Promise<boolean> => {
        try {
    ...
    [
      refetchOrders,
      setFilterCallback,
      fetchWarehouseOrderCallback,
      fetchAcoOrderReportCallback,
      fetchOrderLoadingRecordsCallback,
      updateOrderStatusMutation,
      updateAcoOrderMutation,
      cancelOrderMutation,
      handleError,
    ]
  );
...
export function useWarehouseOrders(filter?: WarehouseOrderFilterInput, config?: OrderDataConfig) {
...
export function useWarehouseOrder(id?: string, orderRef?: string, config?: OrderDataConfig) {
  const orderData = useOrderData(config);
...
export function useAcoOrderReport(reference?: string, config?: OrderDataConfig) {
  const orderData = useOrderData(config);
...
export function useOrderLoadingRecords(filter: OrderLoadingFilterInput, config?: OrderDataConfig) {
  const orderData = useOrderData(config);
