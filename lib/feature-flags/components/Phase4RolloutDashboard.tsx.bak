...
export function Phase4RolloutDashboard() {
  ...
  const { flags, loading } = useFeatureFlags(phase4FeatureFlags.map(f => f.key));
    ...
    <div className='space-y-6 p-6'>
      <div className='flex items-center justify-between'>
        ...
        <Badge variant='secondary' className='text-sm'>
          ...
          {Math.floor((Date.now() - new Date('2025-01-06').getTime()) / (1000 * 60 * 60 * 24)) + 1}{' '}
          of 14
        </Badge>
      </div>
            ...
            <Card key={flag.key}>
              ...
              <CardContent>
                ...
                <div className='mt-3 flex items-center gap-2'>
                  ...
                  />
                  <span className='text-xs'>{isEnabled ? 'Enabled for you' : 'Not enabled'}</span>
                </div>
              </CardContent>
            </Card>
          );
      ...
      <div className='grid grid-cols-2 gap-4 md:grid-cols-4'>
        ...
        <Card>
          <CardContent className='pt-6'>
            ...
            <div className='mt-1 text-sm text-blue-600'>Gradual rollout active</div>
          </CardContent>
        </Card>
      </div>
