...
export function UniversalSuccessCard({
  ...
  const successContent = (
    <SuccessMessage message={message} description={description} action={action} />
  );
...
export const UniversalErrorUtils = {
   ...
   */
  createAsyncErrorCard: (error: Error | string, componentName: string, onRetry?: () => void) => (
    <UniversalErrorCard
      error={error}
      variant='widget'
      widgetName={componentName}
  ...
  ) => <UniversalSuccessCard message={message} description={description} action={action} />,
};
