...
>(({
  ...
  // 發光效果
  const glowEffect = glow && themeConfig.effects.glow ? 
    'hover:shadow-blue-800/20 transition-all duration-300' : '';

  // 動畫效果
  const animationEffect = animation && themeConfig.effects.animation ?
...
export const ResponsiveCard = forwardRef<
  HTMLDivElement,
  ResponsiveCardCompatProps
>(({
  children,
  title,
  subtitle,
