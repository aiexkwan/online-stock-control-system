...
export interface ResponsiveLayoutCompatProps {
  children: React.ReactNode;
  className?: string;
}
...
export interface ResponsiveGridCompatProps {
  children: React.ReactNode;
  columns?: {
    sm?: number;
    md?: number;
...
export interface ResponsiveContainerCompatProps {
  children: React.ReactNode;
  maxWidth?: 'sm' | 'md' | 'lg' | 'xl' | '2xl' | 'full';
  padding?: boolean;
  className?: string;
...
export interface ResponsiveCardCompatProps {
  children: React.ReactNode;
  title?: string;
  subtitle?: string;
  className?: string;
