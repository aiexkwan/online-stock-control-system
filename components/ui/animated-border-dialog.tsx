...
const AnimatedBorder = ({ type = "form" }: { type?: DialogType }) => {
  ...
  return (
    <>
      {/* 頂部邊框 */}
      <div className="absolute top-0 left-0 w-full h-[2px] overflow-hidden rounded-t-3xl">
        <div 
          ref={topRef}
      ...
      {/* 右側邊框 */}
      <div className="absolute top-0 right-0 w-[2px] h-full overflow-hidden rounded-r-3xl">
        <div 
          ref={rightRef}
          className="absolute top-0 left-0 w-full h-full opacity-80"
          style={{
      ...
      {/* 底部邊框 */}
      <div className="absolute bottom-0 left-0 w-full h-[2px] overflow-hidden rounded-b-3xl">
        <div 
          ref={bottomRef}
          className="absolute top-0 left-0 w-full h-full opacity-80"
          style={{
      ...
      {/* 左側邊框 */}
      <div className="absolute top-0 left-0 w-[2px] h-full overflow-hidden rounded-l-3xl">
        <div 
          ref={leftRef}
          className="absolute top-0 left-0 w-full h-full opacity-80"
          style={{
      ...
      <div className={cn(
        ...
        type === "information" ? "bg-cyan-500" :
        type === "report" ? "bg-purple-500" :
        "bg-blue-500"
      )} />
      <div className={cn(
        "absolute bottom-4 left-4 w-2 h-2 rounded-full animate-pulse",
        type === "error" ? "bg-rose-500" :
        type === "warning" ? "bg-amber-500" :
        type === "notification" ? "bg-cyan-500" :
        type === "information" ? "bg-teal-500" :
