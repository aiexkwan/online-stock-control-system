...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'border-input focus:border-ring focus:ring-ring/20 flex h-9 w-full items-center justify-between gap-2 rounded-lg border bg-background px-3 py-2 text-start text-sm text-foreground shadow-sm shadow-black/5 focus:outline-none focus:ring-[3px] disabled:cursor-not-allowed disabled:opacity-50 data-[placeholder]:text-muted-foreground/70 [&>span]:min-w-0',
      className
    )}
    {...props}
  >
