...
export function DialogExamples() {
  ...
  return (
    <div className="p-8 space-y-4">
      <h2 className="text-2xl font-bold mb-6">Dialog 組件示例</h2>
      ...
      <section className="space-y-2">
        ...
        <div className="flex gap-2 flex-wrap">
          ...
          <Button onClick={() => setAnimatedBorder(true)}>
            動畫邊框 Dialog
          </Button>
        </div>
        ...
        <Dialog
          open={animatedBorder}
          onOpenChange={setAnimatedBorder}
          size="sm"
        >
          <DialogContent showAnimatedBorder>
            ...
            <DialogFooter>
              <Button onClick={() => setAnimatedBorder(false)}>
                好的
              </Button>
            </DialogFooter>
          </DialogContent>
