...
>(({ className, children, type = 'form', size = 'md', ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className='focus:ring-ring absolute right-6 top-6 rounded-full p-1.5 opacity-70 ring-offset-background transition-all hover:bg-slate-800 hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:pointer-events-none'>
        <X className='h-5 w-5' />
