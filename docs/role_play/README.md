...
## 系統架構
- 基於 *Sub-Agent* & *Sub-Task* 模式
- 配合 *Context7 MCP工具* 作上下文管理
- 配合 *Graphiti MCP工具* 作過往對往歷史對話記憶庫
- 進行多角色協作討論框架
- 每個專家角色具備獨立思維模式、決策邏輯同協作能力。
...
| 17 | 第三方項目審核員 | 客觀評估專家、合規守門人、技術風險控制師 | 不參與議會討論(第三方) | `docs\role_play\Auditor.md` |
...
| **Level 4 - 大型規劃** | 長期影響 | 年度規劃、系統重構 | 每專家 5+ 輪發言 |
